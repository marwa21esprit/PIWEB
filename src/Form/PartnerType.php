...
class PartnerType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        ->add('namepartner', TextType::class, [
            'constraints' => [
                new NotBlank(['message' => 'Le nom du partenaire ne peut pas être vide.']),
            ],
        ])
            ...
            ->add('description', TextareaType::class, [
                'constraints' => [
                    new NotBlank(['message' => 'la description du patenaire ne peut pas être vide.']),
                ],
            ])
            ...
            ->add('tel', TextType::class, [
                'constraints' => [
                    new NotBlank(['message' => 'le numéro du téléphone ne peut pas être vide.']),
